...
const SelectElement = ({label, keyname, value, options, error, inputHandler}) => (
    <div className="mb-4">
        ...
        <select value={value} onChange={({target: {value}}) => inputHandler(keyname, value)} className="w-full mt-3 p-[.66rem] rounded-lg dark:bg-gray-800 text-gray-700 dark:text-gray-100 border dark:border-0 border-gray-300 focus:ring-2 focus:outline-none">
