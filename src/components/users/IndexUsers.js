...
const IndexUsers = ({itemsPerPage = 10}) => {
    ...
    return (
        <div className="container mx-auto pt-6 pb-4 px-4 md:px-2">
            ...
            {pageCount > 1 ? <PaginateUsers pageHandler={pageHandler} pageCount={pageCount} itemOffset={itemOffset} currentItemsLength={currentItems.length} countTotalResult={users.length} /> : null}
