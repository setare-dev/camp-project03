...
const GridViewItemSelectUsers = ({userId, isSelect, setIsSelect}) => {
    ...
    return (
        <div onClick={selectHandler} className={`${isSelect ? 'bg-indigo-700' : 'bg-gray-200 shadow-sm dark:bg-gray-400'} h-5 w-5 rounded-md cursor-pointer duration-500`}>
...
export default GridViewItemSelectUsers