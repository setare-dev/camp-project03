...
const ScrollTopLayout = () => {
    ...
    return (
        <div onClick={scrollTopHandler} className={`${isShow ? 'block' : 'hidden'} fixed bottom-10 right-12 p-3 cursor-pointer rounded-full bg-indigo-700/75 dark:bg-gray-500/50 shadow-md text-white`}>
